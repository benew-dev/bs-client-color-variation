// app/me/update_password/error.jsx
"use client";
...
/**
 * Composant Error Boundary pour la route /me/update_password
 * Capture toutes les erreurs non gérées de la page de modification de mot de passe
 *
 * Contexte spécifique:
 * - Erreur lors du chargement/affichage du formulaire de changement de mot de passe
 * - Page protégée nécessitant une authentification
 * - Fonctionnalité de sécurité critique
 * - Erreur empêche l'utilisateur de modifier son mot de passe
 *
 * @see https://nextjs.org/docs/app/building-your-application/routing/error-handling
 * @see https://docs.sentry.io/platforms/javascript/guides/nextjs/
 */
export default function UpdatePasswordError({ error, reset }) {
  ...
  useEffect(() => {
    ...
    Sentry.captureException(error, {
      tags: {
        error_boundary: "me-update-password",
        component: "update-password-error",
        page: "/me/update_password",
        critical: true, // Critique (fonctionnalité de sécurité)
      ...
      contexts: {
        password_update: {
          description:
            "Erreur lors de l'affichage du formulaire de changement de mot de passe",
          userAction: "Tentative de modification du mot de passe",
          impact: "L'utilisateur ne peut pas modifier son mot de passe",
          authenticated: true,
        },
      },
      extra: {
    ...
    console.error("UpdatePassword Error Boundary caught error:", {
      name: error.name,
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        ...
        <p className="text-center text-gray-600 mb-8 leading-relaxed">
          ...
          chargement du formulaire de modification de mot de passe. Notre équipe
          a été automatiquement notifiée et travaille pour résoudre ce problème.
        </p>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm text-blue-800 leading-relaxed">
                Votre mot de passe actuel reste actif et sécurisé. Cette erreur
                n&apos;affecte pas la sécurité de votre compte.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 p-4 bg-purple-50 rounded-lg border border-purple-100">
          ...
          <p className="text-sm text-purple-800 leading-relaxed mb-3">
            Si vous souhaitez réinitialiser votre mot de passe au lieu de le
            modifier, vous pouvez utiliser la fonction &quot;Mot de passe
            oublié&quot;.
          </p>
          <Link
        ...
        <div className="mt-6 p-4 bg-white rounded-lg border border-gray-200">
          ...
          <p className="text-sm text-gray-700 leading-relaxed mb-3">
            Si vous devez absolument modifier votre mot de passe pour des
            raisons de sécurité et que le problème persiste, contactez
          ...
          >
            Contacter le support en urgence
          </Link>
        </div>
