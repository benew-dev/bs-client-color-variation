/**
 * Schémas de validation pour les paiements djiboutiens avec support CASH
 * Fichier: helpers/validation/schemas/payment.js
 */

import * as yup from "yup";
import { sanitizeString, validate } from "../core/utils";

// Plateformes de paiement supportées (ajout de CASH)
...
export const validateSimpleInvoice = async (data) => {
  ...
  if (result.isValid) {
    const tax = result.data.amount * 0.07;
    result.calculations = {
